        ...
        socket.on("snapshot", (data) => {
            ...
            state.players.forEach(pState => {
                ...
                if (!pObj) {
                    ...
                    // Use character index from sim state, fallback to lobby, then default
                    const charIdx = (pState.characterIndex !== undefined) ? pState.characterIndex : (lobbyPlayer ? (lobbyPlayer.characterIndex || 0) : 0);
