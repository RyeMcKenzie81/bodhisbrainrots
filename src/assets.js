export function loadAssets() {
    ...
    loadSprite("floor_tropical", "sprites/floor_tropical.png");
    loadSprite("wall_tropical", "sprites/wall_tropical.png");
    loadSprite("block_tropical", "sprites/block_tropical.png");
